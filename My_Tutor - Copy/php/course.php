...
if (isset($_GET['submit'])) {
    ...
    if ($operation == 'search') {
        ...
        $option = $_GET['option'];
        if ($option == "Select") {
            $sqlcourse = "SELECT * FROM tbl_course WHERE course_name LIKE '%$search%'";
        }
    }
} else {
    $sqlcourse = "SELECT * FROM tbl_course";
}
...
<body>
    ...
    <div class="w3-sidebar w3-bar-block" style="display:none" id="mySidebar">
        <button onclick="w3_open()" class="w3-bar-item w3-button w3-large">Close &times;</button>
        <a href="index.php" class="w3-bar-item w3-button">My Profile</a>
        <a href="products.php" class="w3-bar-item w3-button">My History</a>
        <a href="#" class="w3-bar-item w3-button">My Lecturer</a>
        <a href="#" class="w3-bar-item w3-button">My Calender</a>
